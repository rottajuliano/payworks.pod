    ...
    spec.subspec 'mpos' do |mpos|
        ...
        mpos.subspec 'accessories' do |accessories|
            ...
            accessories.subspec 'verifone-e105' do |verifone|
                ...
                verifone.dependency            'payworks-dev/mpos/comlinks/verifone'                
            end
            ...
            # accessories.subspec 'bbpos-wisepad' do |bbpos|
            #     bbpos.vendored_frameworks = 'mpos.accessories.bbpos-wisepad.framework'
        ...
        mpos.subspec 'comlinks' do |comlinks|
            ...
            comlinks.subspec 'tcp' do |externalaccessory|
                externalaccessory.vendored_frameworks = 'mpos.comlinks.tcp.framework'
                externalaccessory.frameworks          = 'ExternalAccessory'
                externalaccessory.dependency            'payworks-dev/mpos/core'
            end
