Pod::Spec.new do |spec|
    ...
    spec.subspec 'mpos' do |mpos|
        ...
        mpos.subspec 'accessories' do |accessories|
            ...
            accessories.subspec 'bbpos-chipper' do |bbposchipper|
                bbposchipper.vendored_frameworks = 'mpos.accessories.bbpos-chipper.framework'
                bbposchipper.frameworks          = 'AVFoundation', 'CoreAudio', 'AudioToolbox', 'MediaPlayer'
                bbposchipper.library             = 'stdc++.6'
                bbposchipper.dependency            'payworks-dev/mpos/core' 
            end      
