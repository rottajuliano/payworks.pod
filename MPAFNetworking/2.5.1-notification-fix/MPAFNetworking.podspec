Pod::Spec.new do |s|
  ...
  s.version  = '2.5.1-notification-fix'
  s.license  = 'MIT'
  s.summary  = 'A delightful iOS and OS X networking framework.'
  s.homepage = 'https://github.com/AFNetworking/AFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'git@bitbucket.org:payworks/io.payworks.mpafnetworking.git', :tag => '2.5.1-notification-fix-9984504', :submodules => true }
  s.requires_arc = true
